...
void copyMatrixWithZeros(const std::vector<std::vector<int>>& originalMatrix, C_Matrix& copyMatrix) {
...
int main(int argc, char **argv)
{
	...
	C_Matrix copyMatrix(0, originalMatrix.size() + 1, 0, originalMatrix[0].size() + 1, 0);
